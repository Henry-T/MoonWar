...
class MyAnalog extends FlxAnalog {
	...
	private override function createBase():Void{
		_base = new FlxSprite(x, y).loadGraphic(GameStatic.screenDensity==1?FlxAssets.imgBase:"assets/img/tbBaseL.png");
	...
	private override function createThumb():Void{
		_stick = new FlxSprite(x, y).loadGraphic(GameStatic.screenDensity==1?FlxAssets.imgStick:"assets/img/tbStickL.png");
