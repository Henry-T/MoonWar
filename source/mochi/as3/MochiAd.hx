...
extern class MochiAd {
	...
	static function closeAdGroup(p1 : flash.display.MovieClip) : Void;
	...
	static function loadDock(p1 : Dynamic) : Void;
	static function loadShowcase(p1 : Dynamic) : Void;
	static function openAdGroup(p1 : flash.display.MovieClip) : Void;
	static function openDockSlider(p1 : flash.display.MovieClip) : Void;
